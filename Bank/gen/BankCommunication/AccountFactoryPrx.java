...
{
    default String createAccount(PersonalData data, Decimal monthlyIncome)
        throws AlreadyRegisteredException
    {
        return createAccount(data, monthlyIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String createAccount(PersonalData data, Decimal monthlyIncome, java.util.Map<String, String> context)
        throws AlreadyRegisteredException
    {
        try
        {
            return _iceI_createAccountAsync(data, monthlyIncome, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> createAccountAsync(PersonalData data, Decimal monthlyIncome)
    {
        return _iceI_createAccountAsync(data, monthlyIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> createAccountAsync(PersonalData data, Decimal monthlyIncome, java.util.Map<String, String> context)
    {
        return _iceI_createAccountAsync(data, monthlyIncome, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_createAccountAsync(PersonalData iceP_data, Decimal iceP_monthlyIncome, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     PersonalData.ice_write(ostr, iceP_data);
                     Decimal.ice_write(ostr, iceP_monthlyIncome);
                 }, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
    ...
    default AccountPrx logIn(String GUID)
        throws InvalidGUIDException
    {
        return logIn(GUID, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default AccountPrx logIn(String GUID, java.util.Map<String, String> context)
        throws InvalidGUIDException
    {
        try
        {
            return _iceI_logInAsync(GUID, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<AccountPrx> logInAsync(String GUID)
    {
        return _iceI_logInAsync(GUID, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> logInAsync(String GUID, java.util.Map<String, String> context)
    {
        return _iceI_logInAsync(GUID, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<AccountPrx> _iceI_logInAsync(String iceP_GUID, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountPrx> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "logIn", null, sync, _iceE_logIn);
        f.invoke(true, context, null, ostr -> {
