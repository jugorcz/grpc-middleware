...
public final class CurrencyServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<CurrencyTypes,
          Currency> METHOD_GET_CURRENCIES =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING,
          generateFullMethodName(
              "CurrencyService", "GetCurrencies"),
          io.grpc.protobuf.ProtoUtils.marshaller(CurrencyTypes.getDefaultInstance()),
  ...
  public static abstract class CurrencyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCurrencies(CurrencyTypes request,
                              io.grpc.stub.StreamObserver<Currency> responseObserver) {
  ...
  public static final class CurrencyServiceBlockingStub extends io.grpc.stub.AbstractStub<CurrencyServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<Currency> getCurrencies(
        CurrencyTypes request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CURRENCIES:
          serviceImpl.getCurrencies((CurrencyTypes) request,
              (io.grpc.stub.StreamObserver<Currency>) responseObserver);
          break;
        default:
  ...
  private static final class CurrencyServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Currencyservice.getDescriptor();
    }
  }
